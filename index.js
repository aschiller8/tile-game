...
// Interaction
window.alert("The object of this game is to retrieve all the keys and go to the chest as fast as possible without encountering an enemy ladybug! Time yourself to see if you can beat your record!")
...
function getoutofmyBubble () {
	...
	if (protagonist.x ===   chest_closed.x && protagonist.y ===   chest_closed.y) {
		window.alert("Congratulations, you survived! But did you bring me all of my keys?");
	}
